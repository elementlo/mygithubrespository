...
public class MyCarListAdapter extends BaseAdapter {
    ...
    public MyCarListAdapter(Context con, List<Map<String, Object>> data,AsyncHttpClient httpClient,ListView lv_carlist) {
        this.data = data;
        this.con = con;
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        view = View.inflate(con, R.layout.listview_mycar, null);
        ...
        /*btn_select_carlist.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                new AlertDialog.Builder(con).setTitle(null).setMessage
...
*//*                                SharedPreferences sp_carInfo = con.getSharedPreferences("carInfo", Context.MODE_PRIVATE);
        ...
        btn_delet_carlist.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new CustomDialog.Builder(con).setTitle(null).setMessage("确认删除吗?").setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        dialog.dismiss();
