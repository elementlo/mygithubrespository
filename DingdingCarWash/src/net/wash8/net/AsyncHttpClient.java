...
//        httpClient = new DefaultHttpClient(cm, httpParams);
   ...
   /**
    ...
    /**
     * Perform a HTTP POST request, without 任意门  parameters.
     * @param url the URL to send the request to.
     * @param responseHandler the response handler instance that should handle the response.
     */
...
//    	params.put("deviceId", anydoorInfo.devicedId);
//    	params.put("deviceType", anydoorInfo.deviceType);
//    	params.put("osVersion", anydoorInfo.osVersion);
//    	params.put("appVersion", anydoorInfo.appVersion);
//    	params.put("sdkVersion", anydoorInfo.sdkVersion);
//    	params.put("appId", anydoorInfo.appId);
//
//    	//如果一账通有登录，则设置用户信息
//    	LoginInfo yztLoginInfo = PAAnydoor.getInstance().getLoginInfo();
//    	if(null != PAAnydoor.getInstance().getLoginInfo() ){
//    	}else{
//    		params.put("userId", "");
//    		params.put("toaPartyNo", "");
//    		params.put("clientNo", "");
//    		params.put("mobileNo", "");
//    	}
//    	AnydoorLog.i("postWithGeneralPara", "url:" + url + "  param:" + params.toString());
...
//    }
    ...
    public void post(Context context, String url, JSONObject jsonObject, String contentType,
